...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.repost_like_ratio'
        db.add_column(u'search_post', 'repost_like_ratio',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.repost_like_ratio'
        db.delete_column(u'search_post', 'repost_like_ratio')
    ...
    models = {
        ...
        u'search.post': {
            ...
            'repost_like_ratio': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'}),
